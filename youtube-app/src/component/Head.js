  ...
  return (
    <div className='grid grid-flow-col shadow-lg'>
        ...
        <div className='flex col-span-8 p-2'>
            <input className="w-1/2 h-8 border border-gray-400 rounded-l-full" type="text"></input>
            <img className="h-8 border border-gray-400 rounded-r-full" alt="search" src="https://img.lovepik.com/element/45004/4703.png_860.png" />
        </div>
